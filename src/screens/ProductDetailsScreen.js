      ...
      >
        ...
        <View style={styles.productHeaderCard}>
          <View style={styles.productIconContainer}>
            <Icon name="cube-outline" size={32} color="#FEC82B" />
          </View>
        ...
        <View style={styles.infoCard}>
          <View style={styles.sectionHeader}>
            <Icon name="document-text-outline" size={20} color="#FEC82B" />
        ...
        <View style={styles.infoCard}>
          <View style={styles.sectionHeader}>
            <Icon name="layers-outline" size={20} color="#FEC82B" />
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Icon name="add-circle-outline" size={22} color="#111827" />
        ...
        {transactions.length > 0 && (
          <View style={styles.infoCard}>
            <View style={styles.sectionHeader}>
              <Icon name="time-outline" size={20} color="#FEC82B" />
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <View style={styles.modalIconContainer}>
                <Icon name="add-circle" size={28} color="#FEC82B" />
              </View>
