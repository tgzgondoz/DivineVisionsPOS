    ...
    return (
      ...
      >
        ...
        <TouchableOpacity
          ...
          disabled={isOutOfStock}
        >
          <Icon name="add-circle" size={42} color={isOutOfStock ? '#D1D5DB' : '#FEC82B'} />
        </TouchableOpacity>
      </TouchableOpacity>
    );
  };
    ...
    return (
      <View style={styles.cartItem}>
        ...
        <View style={styles.cartItemControls}>
          ...
          >
            <Icon name="remove" size={14} color="#111827" />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() => updateQuantity(item.id, item.cartQuantity + 1)}
          >
            <Icon name="add" size={14} color="#111827" />
          </TouchableOpacity>
                    ...
                    {['cash', 'card', 'mobile'].map((method) => (
                      ...
                      >
                        <Icon 
                          ...
                          size={20} 
                          color={paymentMethod === method ? '#111827' : '#6B7280'} 
                        />
                        <Text style={[
